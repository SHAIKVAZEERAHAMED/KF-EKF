...
file_path = r"C:\Users\SHAIK VAZEER AHAMED\OneDrive\Desktop\csv_kf_ekf\M64_3_S_N.csv"

# Load the data from CSV file
data = pd.read_csv(file_path)
data['M64_3_S_N'] = data['M64_3_S_N'].astype(float)
...
initial_state = np.array([data['M64_3_S_N'].iloc[0]])
...
for _, row in data.iterrows():
    measurement = np.array([row['M64_3_S_N']])
